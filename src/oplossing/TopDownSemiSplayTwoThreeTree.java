...
public class TopDownSemiSplayTwoThreeTree<E extends  Comparable<E>> implements SearchTree<E> {
    ...
    public boolean contains(E o) {
        ...
        while (node != null && !node.hasValue(o)) {
            ...
            if (splayPad.size() == 4) {
                ...
                Ss233Node<E> parent = splayPad.pop();
                node = splayOne(first, second, third, parent);
                splayPad.push(node);
            }
    ...
    public Stack<E> findWithSplay(E o) {
        return null;
    }
     ...
     */
    public Ss233Node<E> splayOne(Ss233Node<E> first, Ss233Node<E> second, Ss233Node<E> third, Ss233Node<E> parent) {
